...
for i in {1950..2018};
    do
            csvgrep -c fecha -r "^$i" ~/github/data/records-dias/minimas/records-minima-year.csv | csvstat --count >> ~/github/data/records-dias/minimas/records-count-year.csv
    done
...
csvjoin -u 1 ~/github/data/year.csv ~/github/data/records-dias/minimas/records-count-year.csv > ~/github/data/records-dias/total-records-min.csv
