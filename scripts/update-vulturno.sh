...
bash day-by-day.sh &&
bash frosty.sh &&
bash temperature-max-month.sh marzo 03 &&
bash temperature-min-month.sh marzo 03 &&
bash temperature-last-two-records-max-month.sh Marzo &&
bash temperature-last-two-records-min-month.sh Marzo &&
